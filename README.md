...
First of all, all the information here is taken from my (CISCO CCNA) knowledge, to help people push the NetPractice project of 1337/42 school, and the purpose is just to simplify the project for others and refresh the project concepts for better understanding.
